  ...
  return (
    <div className="flex flex-col">
      <div className="flex items-center space-x-2">
        ...
        {hasItems && (
          <span className="text-xs bg-yellow-100 text-yellow-800 px-1 rounded-full flex items-center justify-center w-4 h-4">
        ...
        {hasNotes && (
          <span className="text-xs bg-blue-100 text-blue-800 px-1 rounded-full flex items-center justify-center w-4 h-4">
