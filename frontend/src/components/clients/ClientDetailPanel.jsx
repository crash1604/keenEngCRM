            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">{clientActivity.length} activit{clientActivity.length !== 1 ? 'ies' : 'y'} recorded</p>
                  </div>
                </div>
              </div>
              ...
              {loadingActivity ? (
                ...
                <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-12 text-center border-2 border-dashed border-gray-200 dark:border-gray-600">
                  ...
                  <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">Changes to this client will appear here</p>
                </div>
              ) : (
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">{clientProjects.length} project{clientProjects.length !== 1 ? 's' : ''} associated with this client</p>
                  </div>
                </div>
              </div>
              ...
              {loadingProjects ? (
                ...
                <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-12 text-center border-2 border-dashed border-gray-200 dark:border-gray-600">
                  ...
                  <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">Projects associated with this client will appear here</p>
                </div>
              ) : (
                <div className="grid gap-4">
                  {clientProjects.map((project) => (
                    <div
                      key={project.id}
                      className="bg-white dark:bg-gray-700 rounded-xl p-5 border border-gray-200 dark:border-gray-600 hover:shadow-lg hover:border-indigo-200 dark:hover:border-indigo-700 transition-all"
                    >
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          {/* Job Number and Name */}
                          <div className="flex items-center gap-3 mb-3">
                            <span className="text-sm font-mono bg-indigo-50 dark:bg-indigo-900 text-indigo-700 dark:text-indigo-300 px-2.5 py-1 rounded-lg font-semibold">
